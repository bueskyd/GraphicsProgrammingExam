...
public:
    ...
    using ShadowShaderSetupFunction = std::function<void(const ShaderProgram&, const Light&, const glm::mat4&, const glm::mat4&)>;
...
public:
    ...
    // Set the verterx shader to use when rendering shadows
    void SetShadowShader(std::shared_ptr<ShaderProgram> shadowShaderProgram, ShadowShaderSetupFunction setupFunction);

    void UseShadowShader(const Light& light, const glm::mat4& lightSpaceMatrix, const glm::mat4& worldMatrix) const;
...
private:
    ...
    std::shared_ptr<ShaderProgram> m_shadowShaderProgram;

    ShadowShaderSetupFunction m_shadowShaderSetupFunction;
};
