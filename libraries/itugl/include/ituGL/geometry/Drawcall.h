...
public:
    ...
    Drawcall(Primitive primitive, GLsizei count, InstancingParam instanced, GLint first = 0);
    Drawcall(Primitive primitive, GLsizei count, Data::Type eboType, InstancingParam instanced, GLint first = 0);
